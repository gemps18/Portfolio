...
export default function Hero() {
  const { t } = useLanguage();
  const role = useTypedText({ strings: t.hero.roles });
  ...
  return (
    ...
    >
      <Reveal origin="left" className="mx-auto max-w-xl md:mx-0">
        <p className="font-mono text-sm text-signal">{t.hero.greeting}</p>
        ...
        <div className="mt-8 flex gap-5 font-mono text-sm text-slate">
          <a href="https://github.com/gemps18" target="_blank" rel="noreferrer" className="hover:text-signal">
            GitHub
          </a>
          <a href="https://www.linkedin.com/in/gemps18/" target="_blank" rel="noreferrer" className="hover:text-signal">
            LinkedIn
          </a>
        </div>
      </Reveal>
